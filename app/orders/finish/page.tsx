...
export default async function MidtransFinishPage(props: { searchParams: Promise<{ [key: string]: string | undefined }> }) {
  ...
  // Tentukan tampilan berdasarkan status dari URL Midtrans
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 max-w-md w-full text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-2 leading-relaxed">
            {isSuccess 
              ...
              : isPending 
              ? 'Silakan selesaikan pembayaran Anda sesuai dengan instruksi metode yang dipilih.' 
        ...
        <div className="pt-4 space-y-3">
          <Link 
            href={`/orders/${orderId}`}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-2xl flex items-center justify-center gap-2 transition shadow-lg shadow-blue-200"
          >
